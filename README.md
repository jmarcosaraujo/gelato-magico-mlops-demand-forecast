...
```
Isso executa: Treinamento, Avaliação, Registro no MLflow e Salvamento do modelo
...
http://127.0.0.1:5000
```
Permite visualizar: Métricas, Parâmetros, Comparação de execuções e Artefatos do modelo
